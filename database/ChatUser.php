...
class ChatUser
{
	...
	// melakukan inisalilasi, menggunakan metode OOP untuk pemanggilan fungsi agar mudah pada saat melakukan pemanggilan.
	...
	// melakukan save pada gambar, dan memposisikannya pada folder.
	...
	// membaut fungsi query database berdasarkan email pada user
	...
	// melakukan save data user
	function save_data()
	{

		$query = "
		INSERT INTO chat_user_table (user_name, user_email, user_password, user_profile, user_created_on, user_verification_code) 
		VALUES (:user_name, :user_email, :user_password, :user_profile, :user_created_on, :user_verification_code)
		";
		$statement = $this->connect->prepare($query);
	...
	// update data user pada saat login, mengetahui status login
