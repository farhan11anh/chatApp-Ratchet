...
$user_object = new ChatUser;  // pemanggilan column yang dugunakan untuk melakukan chat pribadi
...
<body>
	<div class="container-fluid">
		...
		<div class="row">
			...
			<div class="col-lg-3 col-md-4 col-sm-5" style="background-color: #f1f1f1; height: 100vh; border-right:1px solid #ccc; padding-top: 60px;">
				<?php
				...
				<div class="list-group" style=" max-height: 100vh; margin-bottom: 10px; overflow-y:scroll; -webkit-overflow-scrolling: touch;">
					...
					foreach($user_data as $key => $user)
					{
						...
						// melakukan filter terhadap user yang sedang offline ataupun online
			...
			<div class="col-lg-9 col-md-8 col-sm-7">
		        ...
		        <hr />
				<a href="chatroom.php" class="btn btn-primary mt-2 mb-2 float-right">Chat Room</a>
		        <br> <br> <hr>
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		// melakukan inisialisai port yang akan digunakan untuk melakukan chat pribadi
		...
		// menampikan chat area pada halaman setelah user di klik
		function make_chat_area(user_name)
		{
			...
			<form id="chat_form" method="POST" data-parsley-errors-container="#validation_error">
				<div class="input-group mb-3" style="height:7vh">
					<input class="form-control" id="chat_message" name="chat_message" placeholder="Type Message Here" data-parsley-maxlength="1000" data-parsley-pattern="/^[a-zA-Z0-9 ]+$/" required></input	>
					<div class="input-group-append">
						<button type="submit" name="send" id="send" class="btn btn-primary" style="width:100px"></i>Kirim</button>
					</div>
				</div>
